...
"[project]/pages/StudentLogin/index.js [client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function StudentLoginPage() {
    ...
    const [parentCode, setParentCode] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])('');
    const handleLogin = (e)=>{
        e.preventDefault();
        // Perform login action (call your backend here)
        console.log(dob, parentCode);
        const result = dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$redux$2f$Actions$2f$StudentActions$2e$js__$5b$client$5d$__$28$ecmascript$29$__["loginStudent"])({
            dob,
            parentCode
        }));
        if (result) {
...
_s(StudentLoginPage, "rOxXihcAz2VPyQyeUwteijsyuuo=", false, function() {
    return [
...
"[next]/entry/page-loader.ts { PAGE => \"[project]/pages/StudentLogin/index.js [client] (ecmascript)\" } [client] (ecmascript)": (function(__turbopack_context__) {

var { g: global, __dirname, m: module, e: exports } = __turbopack_context__;
{
const PAGE_PATH = "/StudentLogin";
(window.__NEXT_P = window.__NEXT_P || []).push([
    PAGE_PATH,
    ()=>{
        return __turbopack_context__.r("[project]/pages/StudentLogin/index.js [client] (ecmascript)");
    }
]);
...
"[project]/pages/StudentLogin/index.js (hmr-entry)": ((__turbopack_context__) => {
"use strict";

var { g: global, __dirname, m: module } = __turbopack_context__;
{
__turbopack_context__.r("[next]/entry/page-loader.ts { PAGE => \"[project]/pages/StudentLogin/index.js [client] (ecmascript)\" } [client] (ecmascript)");
}}),
}]);

//# sourceMappingURL=%5Broot-of-the-server%5D__07ce635c._.js.map