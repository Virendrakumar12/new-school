...
var __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$axiosInstance$2e$js__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/utils/axiosInstance.js [client] (ecmascript)"); // adjust your path
;
;
...
var __TURBOPACK__imported__module__$5b$project$5d2f$redux$2f$Actions$2f$School$2f$SchoolActions$2e$js__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/redux/Actions/School/SchoolActions.js [client] (ecmascript)"); // your redux action
...
function Login() {
    ...
    const { loading, error } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$redux$2f$dist$2f$react$2d$redux$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__["useSelector"])({
        "Login.useSelector": (state)=>state.schoolLogin
    }["Login.useSelector"]);
    ...
    const handleSubmit = async (e)=>{
        e.preventDefault();
        const result = await dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$redux$2f$Actions$2f$School$2f$SchoolActions$2e$js__$5b$client$5d$__$28$ecmascript$29$__["loginSchool"])(formData));
        if (!result.error) {
...
_s(Login, "AwlJTPYcC5m3y+bNK1yvgjMcRJk=", false, function() {
    return [
...
(window.__NEXT_P = window.__NEXT_P || []).push([
    PAGE_PATH,
    ()=>{
        return __turbopack_context__.r("[project]/pages/Login/index.js [client] (ecmascript)");
    }
]);
...
{
__turbopack_context__.r("[next]/entry/page-loader.ts { PAGE => \"[project]/pages/Login/index.js [client] (ecmascript)\" } [client] (ecmascript)");
}}),
}]);

//# sourceMappingURL=%5Broot-of-the-server%5D__fbdeaf59._.js.map