...
const StudentList = ()=>{
    ...
    const filteredStudents = students.filter((student)=>{
        ...
        const matchesSection = selectedSectionId ? student.currentSection === selectedSectionId : true;
        return matchesSearch && matchesSection;
    });
    const filteredSections = selectedClassId ? sections.filter((sec)=>sec.classId === selectedClassId) : [];
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c71c0d15._.js.map