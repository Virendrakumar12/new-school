...
(()=>{
    const e = new Error("Cannot find module '@/redux/Actions/Class/ClassActions'");
...
function ClassForm() {
    ...
    const handleSubmit = async (e)=>{
        e.preventDefault();
        const res = await dispatch(createClass(formData));
...
_s(ClassForm, "qms9BbWzBmBGFf4DPtlk0lyny9k=", false, function() {
    return [
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d2870ee8._.js.map