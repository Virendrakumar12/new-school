...
"[project]/redux/Slices/MessageSlice.js [client] (ecmascript)": (function(__turbopack_context__) {
...
function ChatBox({ receiverId, receiverType, currentUserId, currentUserType }) {
    ...
    const unreadCount = chatMessages.filter((msg)=>!msg.read && msg.receiverId === currentUserId).length;
        ...
        "ChatBox.useEffect": ()=>{
            if (currentUserId && receiverId) {
                dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$redux$2f$Slices$2f$MessageSlice$2e$js__$5b$client$5d$__$28$ecmascript$29$__["fetchChatHistory"])({
                    ...
                    "ChatBox.useEffect": (err)=>console.error('Failed to load chat history:', err)
                }["ChatBox.useEffect"]);
            }
        }
    }["ChatBox.useEffect"], [
        ...
        "ChatBox.useEffect": ()=>{
            if (conversationId && unreadCount > 0) {
                dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$redux$2f$Slices$2f$MessageSlice$2e$js__$5b$client$5d$__$28$ecmascript$29$__["markMessagesAsRead"])({
                    ...
                    "ChatBox.useEffect": (err)=>console.error('Failed to mark messages as read:', err)
                }["ChatBox.useEffect"]);
            }
        }
    }["ChatBox.useEffect"], [
        ...
        "ChatBox.useEffect": ()=>{
            ...
            const handleNewMessage = {
                "ChatBox.useEffect.handleNewMessage": (msg)=>{
                    // Avoid adding if already exists (by _id or tempId)
                    const exists = messages.some({
                        "ChatBox.useEffect.handleNewMessage.exists": (m)=>m._id === msg._id || msg.tempId && m.tempId === msg.tempId
                    }["ChatBox.useEffect.handleNewMessage.exists"]);
                    if (!exists) {
            ...
            const handleConversationSeen = {
                "ChatBox.useEffect.handleConversationSeen": ({ conversationId: seenConvId })=>{
            ...
            }["ChatBox.useEffect.handleConversationSeen"];
    ...
    const sendMessage = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ChatBox.useCallback[sendMessage]": ()=>{
            ...
            dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$redux$2f$Slices$2f$MessageSlice$2e$js__$5b$client$5d$__$28$ecmascript$29$__["addMessage"])(messagePayload));
            // Emit to server (no _id yet, backend will assign)
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "border p-4 rounded shadow w-full max-w-3xl mx-auto",
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "h-[500px] overflow-y-auto bg-gray-100 p-4 mb-2 rounded",
                children: [
                    ...
                    chatMessages.map((msg)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                        className: `inline-block p-3 rounded-lg shadow ${msg.senderId === currentUserId ? 'bg-blue-500 text-white' : 'bg-white text-gray-800'}`,
                                    ...
                                    msg.senderId === currentUserId && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "text-xs text-right mt-1",
                                        children: renderTick(msg)
                                    }, void 0, false, {
                                        fileName: "[project]/components/ChatBox.js",
                                        lineNumber: 150,
                                        columnNumber: 17
...
_s(ChatBox, "hBC2WSqmVYwRUFxT4qX8EZLt1jw=", false, function() {
    return [
...
"[project]/Utils/getSchoolId.js [client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/pages/TeacherDashboard/SchoolMessage.js [client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$Utils$2f$getSchoolId$2e$js__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Utils/getSchoolId.js [client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
;
;
...
function TeacherDashboard() {
    _s();
    const { teacher } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$redux$2f$dist$2f$react$2d$redux$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__["useSelector"])({
        "TeacherDashboard.useSelector": (state)=>state.teacher
    }["TeacherDashboard.useSelector"]);
    // ✅ updated slice path
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TeacherDashboard.useEffect": ()=>{
            const fetchSchool = {
                "TeacherDashboard.useEffect.fetchSchool": async ()=>{
                    try {
                        let schoolId = null;
                        ...
                        if (teacher && teacher.schoolId) {
                            ...
                            schoolId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Utils$2f$getSchoolId$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"])();
                            setSchool(schoolId);
                        }
                        if (!schoolId) {
            ...
            }["TeacherDashboard.useEffect.fetchSchool"];
            fetchSchool();
        }
    }["TeacherDashboard.useEffect"], [
        teacher
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ChatBox$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"], {
                        receiverId: school,
                        receiverType: "School",
...
_s(TeacherDashboard, "/8/guaKDTBag7732xsvfAyowVAc=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$redux$2f$dist$2f$react$2d$redux$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__["useSelector"]
    ];
});
...
"[next]/entry/page-loader.ts { PAGE => \"[project]/pages/TeacherDashboard/SchoolMessage.js [client] (ecmascript)\" } [client] (ecmascript)": (function(__turbopack_context__) {

var { g: global, __dirname, m: module, e: exports } = __turbopack_context__;
{
const PAGE_PATH = "/TeacherDashboard/SchoolMessage";
(window.__NEXT_P = window.__NEXT_P || []).push([
    PAGE_PATH,
    ()=>{
        return __turbopack_context__.r("[project]/pages/TeacherDashboard/SchoolMessage.js [client] (ecmascript)");
    }
]);
...
"[project]/pages/TeacherDashboard/SchoolMessage.js (hmr-entry)": ((__turbopack_context__) => {
"use strict";

var { g: global, __dirname, m: module } = __turbopack_context__;
{
__turbopack_context__.r("[next]/entry/page-loader.ts { PAGE => \"[project]/pages/TeacherDashboard/SchoolMessage.js [client] (ecmascript)\" } [client] (ecmascript)");
}}),
}]);

//# sourceMappingURL=%5Broot-of-the-server%5D__11409e91._.js.map