    ...
    (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useEffect"])(()=>{
        ...
        newSocket.on('connect', ()=>{
            ...
            if (userId) {
                ...
                console.log('Emitted userOnline with userId:', userId);
            }
        });
        setSocket(newSocket);
        // Clean up on unmount
        ...
        userId
    ]); // <-- include userId so it runs again if user changes
...
"[project]/pages/_app.js [ssr] (ecmascript)": (() => {{

throw new Error("An error occurred while generating the chunk item [project]/pages/_app.js [ssr] (ecmascript)\n\nCaused by:\n- CJS module can't be async.\n\nDebug info:\n- An error occurred while generating the chunk item [project]/pages/_app.js [ssr] (ecmascript)\n- Execution of EcmascriptChunkItemContent::new failed\n- CJS module can't be async.");

}}),

};

//# sourceMappingURL=%5Broot-of-the-server%5D__26abe0c9._.js.map