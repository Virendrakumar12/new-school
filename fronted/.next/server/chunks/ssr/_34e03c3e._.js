...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ClassCard$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/ClassCard.js [ssr] (ecmascript)"); // Import the Card component
 ...
 console.log("fetch class in view class",classes);
  ...
  const handleView = (classId) => {
    ...
    // Handle the view logic (navigate to class details page)
    console.log(`View class with id: ${classId}`);
    
  };
  const handleDelete=(classId)=>{
    console.log("delete section",classId)
  }

  return (
    <div className="p-16">
      <h2 className="text-2xl font-bold text-gray-800 mb-6">Classes</h2>
     {classes.length===0?( "task not found"):(<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
      {Array.isArray(classes) && classes.map((Class) => (
  <ClassCard
    key={Class._id}
    classData={Class} // Pass class data to Card
    onUpdate={handleUpdate} // Pass handleUpdate function to Card
    onView={handleView}
    onDelete={handleDelete} // Pass handleView function to Card
  />
))}
...
//# sourceMappingURL=_34e03c3e._.js.map