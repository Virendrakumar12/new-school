...
const SocketProvider = ({ children, user, userType })=>{
    ...
    console.log("socket provider user", userType);
    (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useEffect"])(()=>{
        if (user) {
            const socketInstance = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$socket$2e$io$2d$client__$5b$external$5d$__$28$socket$2e$io$2d$client$2c$__esm_import$29$__["default"])('http://localhost:8081', {
                query: {
                    userId: user._id,
                    userType
                }
...
const teacherSlice = (0, __TURBOPACK__imported__module__$5b$externals$5d2f40$reduxjs$2f$toolkit__$5b$external$5d$__$2840$reduxjs$2f$toolkit$2c$__esm_import$29$__["createSlice"])({
    ...
    extraReducers: (builder)=>{
        ...
        .addCase(__TURBOPACK__imported__module__$5b$project$5d2f$redux$2f$Actions$2f$TeacherActions$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["loginTeacher"].pending, (state)=>{
            ...
            state.teacherLogin = action.payload.teacher;
...
const useCurrentUser = ()=>{
    ...
    const studentLogin = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2d$redux__$5b$external$5d$__$28$react$2d$redux$2c$__esm_import$29$__["useSelector"])((state)=>state.student);
    const teacherLogin = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2d$redux__$5b$external$5d$__$28$react$2d$redux$2c$__esm_import$29$__["useSelector"])((state)=>state.teacher);
    ...
    console.log("getuser student", studentLogin);
    console.log("getuser teacher", teacherLogin);
    console.log("getuser school", schoolInfo);
    // Return user data and userType based on the available user
    if (studentLogin) {
        return {
            user: studentLogin,
            userType: 'Student'
...
function InnerApp({ Component, pageProps }) {
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$router$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["useRouter"])();
    const { user, userType } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Utils$2f$getUser$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["useCurrentUser"])(); // ✅ now safely inside React context
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c1d9c5f3._.js.map