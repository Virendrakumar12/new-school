...
"[project]/redux/Actions/index.js [ssr] (ecmascript)": (function(__turbopack_context__) {
...
var __TURBOPACK__imported__module__$5b$externals$5d2f40$reduxjs$2f$toolkit__$5b$external$5d$__$2840$reduxjs$2f$toolkit$2c$__esm_import$29$__ = __turbopack_context__.i("[externals]/@reduxjs/toolkit [external] (@reduxjs/toolkit, esm_import)");
var __TURBOPACK__imported__module__$5b$project$5d2f$redux$2f$Actions$2f$index$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/redux/Actions/index.js [ssr] (ecmascript)");
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
    __TURBOPACK__imported__module__$5b$externals$5d2f40$reduxjs$2f$toolkit__$5b$external$5d$__$2840$reduxjs$2f$toolkit$2c$__esm_import$29$__
]);
...
const teacherSlice = (0, __TURBOPACK__imported__module__$5b$externals$5d2f40$reduxjs$2f$toolkit__$5b$external$5d$__$2840$reduxjs$2f$toolkit$2c$__esm_import$29$__["createSlice"])({
    ...
    extraReducers: (builder)=>{
        ...
        .addCase(__TURBOPACK__imported__module__$5b$project$5d2f$redux$2f$Actions$2f$index$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["createTeacher"].pending, (state)=>{
            state.isLoading = true;
        }).addCase(__TURBOPACK__imported__module__$5b$project$5d2f$redux$2f$Actions$2f$index$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["createTeacher"].fulfilled, (state, action)=>{
            state.isLoading = false;
            state.isSuccess = true;
            state.successMessage = 'Teacher created successfully';
            state.teachers.push(action.payload.savedTeacher);
        }).addCase(__TURBOPACK__imported__module__$5b$project$5d2f$redux$2f$Actions$2f$index$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["createTeacher"].rejected, (state, action)=>{
            state.isLoading = false;
            state.isError = true;
            state.errorMessage = action.payload;
        })// GET ALL TEACHERS
        .addCase(__TURBOPACK__imported__module__$5b$project$5d2f$redux$2f$Actions$2f$index$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["getAllTeachers"].pending, (state)=>{
            state.isLoading = true;
        }).addCase(__TURBOPACK__imported__module__$5b$project$5d2f$redux$2f$Actions$2f$index$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["getAllTeachers"].fulfilled, (state, action)=>{
            state.isLoading = false;
            state.teachers = action.payload;
        }).addCase(__TURBOPACK__imported__module__$5b$project$5d2f$redux$2f$Actions$2f$index$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["getAllTeachers"].rejected, (state, action)=>{
            state.isLoading = false;
            state.isError = true;
            state.errorMessage = action.payload;
        })// GET TEACHER BY ID
        .addCase(__TURBOPACK__imported__module__$5b$project$5d2f$redux$2f$Actions$2f$index$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["getTeacherById"].pending, (state)=>{
            state.isLoading = true;
            state.teacher = null;
        }).addCase(__TURBOPACK__imported__module__$5b$project$5d2f$redux$2f$Actions$2f$index$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["getTeacherById"].fulfilled, (state, action)=>{
            state.isLoading = false;
            state.teacher = action.payload;
        }).addCase(__TURBOPACK__imported__module__$5b$project$5d2f$redux$2f$Actions$2f$index$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["getTeacherById"].rejected, (state, action)=>{
            state.isLoading = false;
            state.isError = true;
            state.errorMessage = action.payload;
        })// UPDATE TEACHER
        .addCase(__TURBOPACK__imported__module__$5b$project$5d2f$redux$2f$Actions$2f$index$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["updateTeacher"].pending, (state)=>{
            state.isLoading = true;
        }).addCase(__TURBOPACK__imported__module__$5b$project$5d2f$redux$2f$Actions$2f$index$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["updateTeacher"].fulfilled, (state, action)=>{
            state.isLoading = false;
            state.isSuccess = true;
        ...
        }).addCase(__TURBOPACK__imported__module__$5b$project$5d2f$redux$2f$Actions$2f$index$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["updateTeacher"].rejected, (state, action)=>{
            state.isLoading = false;
            state.isError = true;
            state.errorMessage = action.payload;
        })// DELETE TEACHER
        .addCase(__TURBOPACK__imported__module__$5b$project$5d2f$redux$2f$Actions$2f$index$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["deleteTeacher"].pending, (state)=>{
            state.isLoading = true;
        }).addCase(__TURBOPACK__imported__module__$5b$project$5d2f$redux$2f$Actions$2f$index$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["deleteTeacher"].fulfilled, (state, action)=>{
            state.isLoading = false;
            state.isSuccess = true;
            state.successMessage = 'Teacher deleted successfully';
            state.teachers = state.teachers.filter((t)=>t._id !== action.payload.id);
        }).addCase(__TURBOPACK__imported__module__$5b$project$5d2f$redux$2f$Actions$2f$index$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["deleteTeacher"].rejected, (state, action)=>{
            state.isLoading = false;
            state.isError = true;
            state.errorMessage = action.payload;
        });
...
([__TURBOPACK__imported__module__$5b$externals$5d2f40$reduxjs$2f$toolkit__$5b$external$5d$__$2840$reduxjs$2f$toolkit$2c$__esm_import$29$__, __TURBOPACK__imported__module__$5b$project$5d2f$redux$2f$Slices$2f$schoolSlice$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__, __TURBOPACK__imported__module__$5b$project$5d2f$redux$2f$Slices$2f$classSlice$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__, __TURBOPACK__imported__module__$5b$project$5d2f$redux$2f$Slices$2f$sectionSlice$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__, __TURBOPACK__imported__module__$5b$project$5d2f$redux$2f$Slices$2f$TeacherSlice$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__);
;
;
;
;
...
//# sourceMappingURL=%5Broot-of-the-server%5D__de4583ad._.js.map